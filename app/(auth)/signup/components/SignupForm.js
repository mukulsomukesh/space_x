    ...
    return (
        ...
        <div>
            ...
            <div className=' mt-10 bg-gradient-to-r from-[#488da9] to-[#e5f4df] p-[2px]' >
                <input className='bg-black w-full text-white px-2 py-2 ' value={formData.naame} onChange={(e) => setFormData({ ...formData, name: e.target.value })} name='name' placeholder='Enter your name' />
            </div>
            ...
            <div className="mt-8">
                ...
                <Link href={"/login"} className="font-bold text-[#488da9] " > Login </Link>
            </div>
